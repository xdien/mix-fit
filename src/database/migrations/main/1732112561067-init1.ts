...
export class Init11732112561067 implements MigrationInterface {
    name = 'Init11732112561067'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "posts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "user_id" uuid NOT NULL, CONSTRAINT "PK_2829ac61eff60fcec60d7274b9e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."device_telemetry_value_type_enum" AS ENUM('numeric', 'text', 'media', 'binary')`);
        await queryRunner.query(`CREATE TABLE "device_telemetry" ("device_telemetry_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "device_id" character varying NOT NULL, "metadata" jsonb DEFAULT '{}', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "value_type" "public"."device_telemetry_value_type_enum" NOT NULL, "numeric_value" numeric(10,2), "text_value" character varying, "media_url" character varying, "binary_value" boolean, CONSTRAINT "PK_7fc98d2ddc0b6e4b356625261a6" PRIMARY KEY ("device_telemetry_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_64b7753e53da4770c4a9089a38" ON "device_telemetry" ("device_id") `);
        await queryRunner.query(`CREATE TABLE "device_commands" ("command_id" character varying NOT NULL, "command" character varying NOT NULL, CONSTRAINT "PK_af4492046bfb9c6de03b314a773" PRIMARY KEY ("command_id"))`);
        await queryRunner.query(`CREATE TABLE "device_types" ("device_type_id" character varying NOT NULL, CONSTRAINT "PK_2d7fd9719c77f0c85c937bb5f62" PRIMARY KEY ("device_type_id"))`);
        await queryRunner.query(`CREATE TABLE "device" ("created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "device_id" character varying NOT NULL, "name" character varying, "description" character varying, "model" character varying, "device_type_device_type_id" character varying, CONSTRAINT "PK_17d554d4f6b44ff0e200ee4b920" PRIMARY KEY ("device_id"))`);
        await queryRunner.query(`CREATE TYPE "public"."command_logs_status_enum" AS ENUM('PENDING', 'SENT', 'DELIVERED', 'EXECUTED', 'FAILED')`);
        await queryRunner.query(`CREATE TABLE "command_logs" ("device_command_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "device_id" character varying NOT NULL, "status" "public"."command_logs_status_enum" NOT NULL DEFAULT 'PENDING', "device_type" character varying NOT NULL, "payload" jsonb NOT NULL, "executed_at" TIMESTAMP, "error_message" character varying, "result" jsonb, "sent_at" TIMESTAMP, CONSTRAINT "PK_b9f0772d62a03c394e2d9199dcd" PRIMARY KEY ("device_command_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "device" ADD CONSTRAINT "FK_9333f64fab9c41ec731e30a55c8" FOREIGN KEY ("device_type_device_type_id") REFERENCES "device_types"("device_type_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "device" DROP CONSTRAINT "FK_9333f64fab9c41ec731e30a55c8"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."device_telemetry_value_type_enum"`);
